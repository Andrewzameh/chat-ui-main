<script lang="ts">
	...
	import Logo2 from "$lib/components/icons/Logo-copy.svelte";
	...
	<div class="lg:col-span-1">
		<div>
			<div class="mb-3 flex items-center text-2xl font-semibold">
				...
				<Logo2 classNames="mr-1  ml-2 flex-none" />
				<!-- {PUBLIC_APP_NAME} -->
				<div
			...
			<p class="text-base text-gray-600 dark:text-gray-400">
				Making the community's best AI chat models available to every employee.
			</p>
		</div>
	</div>
